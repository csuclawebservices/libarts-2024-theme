	...
	edit: (props) => {
		...
		return (
			<div { ...blockProps }>
				...
				<RichText tagName="p" onChange={ (newValue) => {props.setAttributes({content: newValue}); }} value={props.attributes.content} placeholder={'Content...'}/>
			</div>
		)
	},
	...
	save: (props) => {
		...
		<div { ...useBlockProps.save() }>
			<div className="header-media-wrapper has-csu-fye-side-decoration-left">
					...
					<InnerBlocks.Content className="header-media" />
				</div>
