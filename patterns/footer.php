 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"infinitum/footer","name":"Footer"},"align":"full","className":"site-footer","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}},"heading":{"color":{"text":"var:preset|color|energy-green"}}},"spacing":{"padding":{"top":"var:preset|spacing|2"}}},"backgroundColor":"oval-green","textColor":"white","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull site-footer has-white-color has-oval-green-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--2)">
	<!-- wp:columns -->
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<div class="wp-block-columns is-not-stacked-on-mobile">
				...
				<div class="wp-block-column" style="flex-basis:50%">
					<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"cla/global-links-cla"}},"name":"Global Links (CLA)"},"fontSize":"90"} --><p class="has-90-font-size"></p><!-- /wp:paragraph -->
				</div>
				<!-- /wp:column -->

				<!-- wp:column {"width":"50%"} -->
				<div class="wp-block-column" style="flex-basis:50%">
					<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"cla/global-links-csu"}},"name":"Global Links (CSU)"},"fontSize":"90"} --><p class="has-90-font-size"></p><!-- /wp:paragraph -->
